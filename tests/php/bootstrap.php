<?php
/**
 * PHPUnit bootstrap for PostNL for WooCommerce unit tests.
 *
 * Defines the minimal WordPress stubs required by the plugin's ABSPATH guard
 * and filter system, then loads the Composer autoloader.
 */
