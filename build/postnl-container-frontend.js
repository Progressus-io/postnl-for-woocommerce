...
/* harmony import */ var _postnl_delivery_day_block__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../postnl-delivery-day/block */ "./src/Checkout_Blocks/js/postnl-delivery-day/block.js");
/* harmony import */ var _postnl_dropoff_points_block__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../postnl-dropoff-points/block */ "./src/Checkout_Blocks/js/postnl-dropoff-points/block.js");
...
const Block = ({
  ...
  const tabs = [{
    id: 'delivery_day',
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Delivery Day', 'postnl-for-woocommerce')
  }, {
    id: 'dropoff_points',
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Dropoff Points', 'postnl-for-woocommerce')
  }];

  // State for the active tab
  const [activeTab, setActiveTab] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(tabs[0].id);

  // Get the letterbox status from settings
  const postnlData = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_3__.getSetting)('postnl-for-woocommerce-blocks_data', {});
  const letterbox = postnlData.letterbox || false;

  // Retrieve customer data from WooCommerce cart store
  const customerData = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
  ...
  const [showContainer, setShowContainer] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (shippingAddress) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9__["default"].post(postnlData.ajax_url, formData, {
        ...
        if (response.data.success && response.data.data && response.data.data.delivery_options && response.data.data.delivery_options.length > 0) {
          setShowContainer(true);
        } else {
          setShowContainer(false);
        }
  ...
  if (letterbox) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
      ...
      children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('These items are eligible for letterbox delivery.', 'postnl-for-woocommerce')
    });
  } else if (loading) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Spinner, {});
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_postnl_delivery_day_block__WEBPACK_IMPORTED_MODULE_6__.Block, {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_postnl_dropoff_points_block__WEBPACK_IMPORTED_MODULE_7__.Block, {
            checkoutExtensionData: checkoutExtensionData,
