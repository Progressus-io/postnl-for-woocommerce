...
<div class="postnl-login-button__container <?php echo esc_attr( implode( ' ', $wrapper_classes ) ); ?> <?php echo esc_attr( $button_class ); ?>">
	<button id="postnl-login-button" aria-label="<?php esc_attr_e( 'Autofill with PostNL', 'postnl-for-woocommerce' ); ?>" href="#">
		<img src="<?php echo esc_url( $postnl_logo_url ); ?>" alt="<?php esc_attr_e( 'PostNL Logo', 'postnl-for-woocommerce' ); ?>" id="postnl-logo" />
		<span id="postnl-login-button__text">
			<?php esc_html_e( 'Autofill with PostNL', 'postnl-for-woocommerce' ); ?>
		</span>
	</button>
