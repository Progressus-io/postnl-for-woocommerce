...
/***/ "./src/Checkout_Blocks/js/postnl-shipping-address/block.js":
/*!*****************************************************************!*\
  !*** ./src/Checkout_Blocks/js/postnl-shipping-address/block.js ***!
  \*****************************************************************/
...
const Block = ({
  ...
  const [shippingHouseNumber, setShippingHouseNumber] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('');

  // Retrieve customer data from WooCommerce cart store
  const customerData = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (shippingAddress && billingAddress && shippingHouseNumber) {
      const data = {
        ...
        // Changed from array to string as per PHP handler
      ...
      axios__WEBPACK_IMPORTED_MODULE_6__["default"].post(window.postnl_ajax_object.ajax_url, formData, {
        headers: {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Enter your house number', 'postnl-for-woocommerce'),
...
/***/ "./src/Checkout_Blocks/js/postnl-shipping-address/block.json":
/*!*******************************************************************!*\
  !*** ./src/Checkout_Blocks/js/postnl-shipping-address/block.json ***!
  \*******************************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":2,"name":"postnl/postnl-shipping-address","version":"2.0.0","title":"shipping fields","category":"woocommerce","description":"","supports":{"html":false,"align":false,"multiple":false,"reusable":false},"parent":["woocommerce/checkout-shipping-address-block"],"attributes":{"lock":{"type":"object","default":{"remove":true,"move":true}},"shippingHouseNumber":{"type":"string","default":""}},"textdomain":"postnl-for-woocommerce","editorStyle":"file:../../../build/style-postnl-for-woocommerce-block.css"}');
...
(() => {
/*!********************************************************************!*\
  !*** ./src/Checkout_Blocks/js/postnl-shipping-address/frontend.js ***!
  \********************************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block */ "./src/Checkout_Blocks/js/postnl-shipping-address/block.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/Checkout_Blocks/js/postnl-shipping-address/block.json");
/**
 * External dependencies
 */
...
/******/ })()
;
//# sourceMappingURL=postnl-shipping-address-frontend.js.map