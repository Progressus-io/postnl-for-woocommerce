...
/***/ "./src/Checkout_Blocks/js/postnl-container/block.js":
/*!**********************************************************!*\
  !*** ./src/Checkout_Blocks/js/postnl-container/block.js ***!
  \**********************************************************/
...
/* harmony import */ var _postnl_delivery_day_block__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../postnl-delivery-day/block */ "./src/Checkout_Blocks/js/postnl-delivery-day/block.js");
/* harmony import */ var _postnl_dropoff_points_block__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../postnl-dropoff-points/block */ "./src/Checkout_Blocks/js/postnl-dropoff-points/block.js");
...
const Block = ({
  ...
  const tabs = [{
    id: 'delivery_day',
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Delivery Day', 'postnl-for-woocommerce')
  }, {
    id: 'dropoff_points',
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Dropoff Points', 'postnl-for-woocommerce')
  }];

  // State for the active tab
  const [activeTab, setActiveTab] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(tabs[0].id);

  // Get the letterbox status from settings
  const postnlData = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_2__.getSetting)('postnl-for-woocommerce-blocks_data', {});
  ...
  const customerData = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
  ...
  const [showContainer, setShowContainer] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  const {
    setShippingAddress
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useDispatch)(CART_STORE_KEY);

  // Create a debounced shipping address state
  const [debouncedShippingAddress, setDebouncedShippingAddress] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(shippingAddress);
  ...
  const debouncedSetShippingAddress = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(lodash_debounce__WEBPACK_IMPORTED_MODULE_7___default()(newShippingAddress => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (debouncedShippingAddress) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9__["default"].post(postnlData.ajax_url, formData, {
        headers: {
        ...
        if (response.data.success) {
          ...
          if (response.data.data.validated_address) {
            ...
            const newShippingAddress = {
              ...
              address_1: street,
              // Update address_1 with validated street
              city: city // Update city with validated city
            };
            if (debouncedShippingAddress.address_1 !== street || debouncedShippingAddress.city !== city) {
              debouncedSetShippingAddress(newShippingAddress);
            }
          }
          if (response.data.data.delivery_options && response.data.data.delivery_options.length > 0) {
            setShowContainer(true);
          } else {
            setShowContainer(false);
          }
  ...
  }, [debouncedShippingAddress, postnlData.ajax_url, postnlData.nonce, setExtensionData, debouncedSetShippingAddress]);
  if (letterbox) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
      className: "postnl-letterbox-message",
      children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('These items are eligible for letterbox delivery.', 'postnl-for-woocommerce')
    });
  } else if (loading) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Spinner, {});
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
        className: "postnl_checkout_tab_container",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("ul", {
          className: "postnl_checkout_tab_list",
          children: tabs.map(tab => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("li", {
        ...
        className: "postnl_checkout_content_container",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          className: `postnl_content ${activeTab === 'delivery_day' ? 'active' : ''}`,
          id: "postnl_delivery_day_content",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_postnl_delivery_day_block__WEBPACK_IMPORTED_MODULE_5__.Block, {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_postnl_dropoff_points_block__WEBPACK_IMPORTED_MODULE_6__.Block, {
            checkoutExtensionData: checkoutExtensionData,
...
/***/ "./src/Checkout_Blocks/js/postnl-delivery-day/block.js":
/*!*************************************************************!*\
  !*** ./src/Checkout_Blocks/js/postnl-delivery-day/block.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Block = ({
    ...
    if (isActive) {
      ...
      if (!selectedOption && deliveryOptionsRef.current.length > 0) {
        ...
        if (Array.isArray(firstDelivery.options) && firstDelivery.options.length > 0) {
          ...
          handleOptionChange(`${firstDelivery.date}_${firstOption.from}-${firstOption.to}_${firstOption.price}`, firstDelivery.date, firstOption.from, firstOption.to, firstOption.type || 'Unknown', firstOption.price || 0);
        }
      }
    } else {
      // Tab is inactive
  ...
  const fetchDeliveryOptions = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    ...
    formData.append('nonce', postnlData.nonce);
    axios__WEBPACK_IMPORTED_MODULE_6__["default"].post(postnlData.ajax_url, formData, {
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded'
      }
    }).then(response => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("ul", {
      className: "postnl_delivery_day_list postnl_list",
      children: deliveryOptionsRef.current.map((delivery, index) => Array.isArray(delivery.options) && delivery.options.length > 0 ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("li", {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
          className: "list_title",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span", {
            children: `${delivery.date} ${delivery.day}`
          })
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("ul", {
          className: "postnl_sub_list",
          children: delivery.options.map((option, optionIndex) => {
            const from = option.from || '';
            const to = option.to || '';
            ...
            if (optionType === 'Evening') {
              delivery_time = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Evening', 'postnl-for-woocommerce');
            } else if (optionType === 'Morning' || optionType === '08:00-12:00') {
              delivery_time = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Morning', 'postnl-for-woocommerce');
            } else {
              delivery_time = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)(optionType, 'postnl-for-woocommerce');
            }
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("li", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("label", {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("input", {
                  ...
                  value: value,
                  checked: isChecked,
                  onChange: () => handleOptionChange(value, delivery.date, from, to, optionType, price)
                }), price > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("i", {
...
/***/ "./src/Checkout_Blocks/js/postnl-dropoff-points/block.js":
/*!***************************************************************!*\
  !*** ./src/Checkout_Blocks/js/postnl-dropoff-points/block.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Block = ({
   ...
   */
  const fetchDropoffOptions = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    setUpdating(true);
    setError('');
    const formData = new URLSearchParams();
   ...
   */
  if (error) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Notice, {
      status: "error",
      isDismissible: false,
      children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)(error, 'postnl-for-woocommerce')
    });
  }
   ...
   */
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
    children: [dropoffOptions.some(point => point.show_desc) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
      className: "postnl_content_desc",
      children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Receive shipment at home? Continue ', 'postnl-for-woocommerce'), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("strong", {
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('without', 'postnl-for-woocommerce')
      }), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)(' selecting a Drop-off Point.', 'postnl-for-woocommerce')]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("ul", {
      className: "postnl_dropoff_points_list postnl_list",
      children: dropoffOptions.map((point, index) => {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("li", {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span", {
              className: "company",
              children: point.address.company
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span", {
              className: "distance",
              children: Utils.maybe_convert_km(point.distance)
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("ul", {
            className: "postnl_sub_list",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("li", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("label", {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("input", {
                  ...
                  children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)(point.type, 'postnl-for-woocommerce')
                }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span", {
                  children: address
                })]
              })
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":2,"name":"postnl/postnl-container","version":"1.0.0","title":"Postnl Tabs","category":"woocommerce","description":"","supports":{"html":false,"align":false,"multiple":false,"reusable":false},"parent":["woocommerce/checkout-order-summary-block"],"attributes":{"lock":{"type":"object","default":{"remove":true,"move":true}}},"textdomain":"postnl-for-woocommerce","editorStyle":"file:../../../build/style-postnl-for-woocommerce-block.css"}');
...
"use strict";
/*!*************************************************************!*\
  !*** ./src/Checkout_Blocks/js/postnl-container/frontend.js ***!
  \*************************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block */ "./src/Checkout_Blocks/js/postnl-container/block.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/Checkout_Blocks/js/postnl-container/block.json");
/**
 * External dependencies
 */
...
/******/ })()
;
//# sourceMappingURL=postnl-container-frontend.js.map