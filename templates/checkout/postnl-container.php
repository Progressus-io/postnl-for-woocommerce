				...
				<div class="postnl_content" id="postnl_dropoff_points_content">
					<ul class="postnl_dropoff_points_list postnl_list">
						<?php foreach ( $dropoff_points as $point ) { ?>
							<?php
							$value      = $point['partner_id'];
							$partner_id = sanitize_title( $point['partner_id'] );
							?>
						<li>
							<div class="list_title"><span><?php echo esc_html( $point['company'] . ' ' . $point['distance'] ); ?></span></div>
							<ul class="postnl_sub_list">
								<li>
									<label class="postnl_sub_radio_label" for="postnl_dropoff_points_<?php echo esc_attr( $partner_id ); ?>">
										<input type="radio" id="postnl_dropoff_points_<?php echo esc_attr( $partner_id ); ?>" name="postnl_dropoff_points" class="postnl_sub_radio" value="<?php echo esc_attr( $point['partner_id'] ); ?>" />
