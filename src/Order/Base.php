		...
		return apply_filters(
			...
			array(
				array(
					...
					'type'              => 'text',
					'label'             => __( 'Dropoff Points Company:', 'postnl-for-woocommerce' ),
					'description'       => '',
					'class'             => 'long',
					'value'             => '',
				...
				array(
					...
					'type'              => 'textarea',
					'label'             => __( 'Dropoff Points Address:', 'postnl-for-woocommerce' ),
					'description'       => '',
					'class'             => 'long',
					'value'             => '',
					'custom_attributes' => array( 'readonly' => 'readonly' ),
				...
				array(
					...
					'type'              => 'text',
					'label'             => __( 'Dropoff Points Date:', 'postnl-for-woocommerce' ),
					'description'       => '',
					'class'             => 'long',
					'value'             => '',
					'custom_attributes' => array( 'readonly' => 'readonly' ),
				...
				array(
					...
					'type'              => 'text',
					'label'             => __( 'Dropoff Points Time:', 'postnl-for-woocommerce' ),
					'description'       => '',
					'class'             => 'long',
					'value'             => '',
					'custom_attributes' => array( 'readonly' => 'readonly' ),
				...
				array(
					'id'                => $this->prefix . 'dropoff_points_type',
					'type'              => 'text',
					'label'             => __( 'Dropoff Points Type:', 'postnl-for-woocommerce' ),
					'description'       => '',
					'class'             => 'long',
					'value'             => '',
					'custom_attributes' => array( 'readonly' => 'readonly' ),
